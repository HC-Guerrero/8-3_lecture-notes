 ...
 * 1
 *
 * The .every() method expects at least one argument. What data type is this argument? //A callback function
...
console.log( 'is every pen fountain (n.a.m):', pens.every(function(pen)  {
  pen.style === 'fountain';
